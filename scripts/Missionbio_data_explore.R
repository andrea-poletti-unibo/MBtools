...
df <- data.table::fread("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT Single-Cell - Documenti/DFCI_Ghobrial_RUN/h5_files_stats.tsv", skip = 1)
...
dfB1 <- data.table::fread("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT Single-Cell - Documenti/RUN1/h5_files_stats_RUN1.tsv", skip = 1)
...
dfB2 <- xlsx::read.xlsx("C:/Users/andre/Alma Mater Studiorum Università di Bologna/PROJECT Single-Cell - Documenti/RUN2/h5_files_stats.xlsx", sheetIndex = 1)
