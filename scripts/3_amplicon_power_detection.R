...
# add chromosome arm info to amplicons: Popeye2 function
...
cl_CN <- xlsx::read.xlsx("data/MM_CELL_LINES_CN_annotation.xlsx", sheetIndex = 1)
...
write_tsv(df_single_amps2, "data/amplicon_empirical_powers.txt")
